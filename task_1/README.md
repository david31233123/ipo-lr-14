...
1. Ознакомиться с библиотекой Pillow и её основными возможностями для работы с изображениями.
2. Освоить использование объектно-ориентированного подхода (ООП) для создания классов и их взаимодействия.
3. Развить навыки разработки программ, которые выполняют обработку изображений с использованием библиотек Python.
